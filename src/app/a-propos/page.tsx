      ...
      <main>
        ...
        <section className="px-4 sm:px-6 lg:px-8 pt-16 md:pt-24 pb-12 md:pb-16">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-start gap-6 md:gap-8 mb-6">
              <LogoSymbol className="w-20 h-20 md:w-24 md:h-24 shrink-0" />
              <div className="pt-2">
                <span className="label-mark">Notre maison</span>
              </div>
            </div>

            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-medium text-sepia tracking-tight-1 leading-tight">
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-16 md:py-20 bg-perle/20 border-y border-perle">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="mt-3 font-serif text-3xl md:text-4xl font-medium text-sepia tracking-tight-1 leading-tight mb-10">
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-10">
              ...
              <div className="shrink-0 mx-auto md:mx-0">
                <div className="relative w-40 h-40 md:w-48 md:h-48 rounded-full overflow-hidden border-2 border-or-pale shadow-md">
                  <Image
                ...
                <p className="mt-3 text-center md:text-left font-sans text-xs text-pierre">
                  <span className="block font-semibold text-sepia">Imad Belfaqir</span>
                  <span className="block">Fondateur</span>
                </p>
              </div>

              {/* Prose */}
              <div className="flex-1 space-y-6 font-sans text-base md:text-lg text-sepia leading-relaxed">
                <p>
                  QWESTINUM ne s&apos;est pas construite sur une mode. Avant
                  l&apos;IA générative, avant les agents, avant les LLM, son
                  fondateur{' '}
                  <strong className="font-medium">Imad Belfaqir</strong> a passé
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-5 font-sans text-base md:text-lg text-sepia leading-relaxed">
              <p>
                ...
                <strong className="font-medium">Process First</strong> — et un
